...
- Dungeon/shop/relic/UI: `DEBUG_DUNGEON_LOGS`, `DEBUG_FOCUS_LOGS`, `DEBUG_INTERACT_LOGS`, `DEBUG_PROP_INTERACT_LOGS`, `DEBUG_TRAP_LOGS`, `DEBUG_CHEST_INTERACT_LOGS` (legacy), `DEBUG_RELIC_LOGS`, `DEBUG_UI_LOGS`, `DEBUG_UIAPI_LOGS`, `DEBUG_SHOP_LOGS`, `DEBUG_COINS_LOGS`, `DEBUG_RELICTIP_LOGS`
...
- Arcade compat: `DEBUG_NET`, `DEBUG_NET_SNAPSHOT`, `DEBUG_TILEMAP_COMPAT`, `DEBUG_COMPAT_*`, `DEBUG_SPRITE_*`, `DEBUG_SPRITE_SYNC`, `DEBUG_ROLE_*`, `DEBUG_ENEMY_POS_GUARD`, `DEBUG_ENEMY_POS_GUARD_THROW`
