...
- Dungeon/shop/relic/UI: `DEBUG_DUNGEON_LOGS`, `DEBUG_FOCUS_LOGS`, `DEBUG_CHEST_INTERACT_LOGS`, `DEBUG_RELIC_LOGS`, `DEBUG_UI_LOGS`, `DEBUG_UIAPI_LOGS`, `DEBUG_SHOP_LOGS`, `DEBUG_COINS_LOGS`, `DEBUG_RELICTIP_LOGS`
...
- Arcade compat: `DEBUG_NET`, `DEBUG_NET_SNAPSHOT`, `DEBUG_TILEMAP_COMPAT`, `DEBUG_COMPAT_*`, `DEBUG_SPRITE_*`, `DEBUG_SPRITE_SYNC`, `DEBUG_ROLE_*`
