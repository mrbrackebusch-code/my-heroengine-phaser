...
export const DEBUG_SHRINE_OVERLAY_LOGS = true; // Shrine: log overlay state changes/failures.
export const DEBUG_SHRINE_OBSERVER = true; // Shrine: checklist observer (end-to-end report).
...
export const DEBUG_DRAW_WALL_COLLIDERS = true; //Show tile collisions for all
export const DEBUG_DRAW_ENEMY_WALL_COLLIDERS = true; //Enemy collider
...
export const DEBUG_DRAW_EFFECT_BOUNDS = true; // Effect sprite bounds (frame + nontransparent)
