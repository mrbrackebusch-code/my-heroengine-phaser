...
export const DEBUG_FILTER_LOGS = false;      // gate input/move filter logs
...
export const DEBUG_HERO_SPAWN_LOGS = false;
...
export const DEBUG_HERO_ANIM_FRAMES = false;
export const DEBUG_HERO_ANIM_FRAMES_STRENGTH_ONLY = false;
...
export const DEBUG_SPECIAL_PHASE_LOG_ONCE = false;
export const DEBUG_MANA_FAIL_LOG_ONCE = false;
...
export const DEBUG_EFFECTS_HALL_LOGS = true; // Log effects hall texture frames (debug).
...
export const DEBUG_NET_IDENTITY = false; // Profile/identity lifecycle logs.
...
export const DEBUG_VFX_GALLERY = false; // Overlay grid of effect sheets for quick visual inspection.
export const DEBUG_VFX_GALLERY_IDS = ""; // Comma/space-separated effect IDs (empty = all).
export const DEBUG_VFX_GALLERY_MAX = 120; // Hard cap on effect tiles drawn.
export const DEBUG_VFX_GALLERY_COLS = 8; // Grid columns.
export const DEBUG_VFX_GALLERY_SCALE = 0.5; // Sprite scale for gallery tiles.
...
export const DEBUG_KIND56_CREATE_TRACE = false;
